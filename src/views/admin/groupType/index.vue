...
<span>{{scope.row.code}}</span>
        ...
        <el-table-column  align="center" label="类型名称"><template scope="scope">
  <span>
                {{scope.row.name}}</span>
</template>
...
<span>
        ...
        <el-table-column  align="center" label="最后更新时间"><template scope="scope">
  <span>
                {{scope.row.updTime}}</span>
</template>

    </el-table-column>
        <el-table-column  align="center" label="最后更新人"><template scope="scope">
  <span>
                {{scope.row.updName}}</span>
</template>

    </el-table-column>
        <el-table-column  align="center" label="最后更新主机"><template scope="scope">
  <span>
