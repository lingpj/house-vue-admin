  ...
  <div class="container">
      ...
      <el-row>
        ...
        <el-col :span="2" :offset="20" style="margin-bottom:10px">
          <el-upload
            ...
            :data="{company:'company',dept:'dept',username:this.$store.state.user.name}"
    ...
    <div>
      <el-table :data="tableDataArr" border fit highlight-current-row>
        ...
        <el-table-column prop="itemname" label="条目名称" align="center"></el-table-column>
        <el-table-column prop="company" label="公司名称" align="center"></el-table-column>
        <el-table-column prop="deptname" label="部门" align="center"></el-table-column>
        <el-table-column prop="file_path" label="下载" align="center">
        ...
        <el-table-column prop="createtime" :formatter="formatDate" label="上传时间" align="center"></el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    ...
    getTableData: function() {
      ...
      this.$fetch({
        url: process.env.dropdbandescape + "/budget/budgetinfo/pageList",
        method: "post",
        data: {
